...
import { listFacts, readFact, writeFact, writeFileAtomic, validateSlug } from "./store.js";
...
export function serializeBundle(facts) {
...
export function exportGlobals(globalDirPath, filePath) {
...
export function importGlobals(globalDirPath, filePath, overwrite) {
    const resolved = expandTilde(filePath);
    ...
    const result = { imported: 0, unchanged: 0, skipped: [], overwritten: 0 };
...
//# sourceMappingURL=globals-sync.js.map
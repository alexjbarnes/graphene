...
const TOOLS = [
  {
    name: "status",
    description:
      "Get full context for this session in one call. Returns the node index, any stale nodes, current HEAD commit, and all user preferences/facts. Call this at the start of every session.",
    inputSchema: {
